...
#' It returns the trained model and a data.frame describing the features used 
#' for the model.
#' 
...
#' \code{n_max} will be used for the model.
#'
...
#' @param n_max            \code{int} (=\code{200}) maximum number of features 
#'                         to use for the model. 
#'                         Features will be chosen by correlation adjusted t 
#'                         scores.
#' @param diag             \code{bool} (=\code{FALSE}) if true DDA instead 
#'                         of LDA is done
#' @param verb             \code{bool} (=\code{FALSE}) verbose, if true sda 
#'                         training messages will be printed
#' 
#' @return \code{list} of 2 objects
#' \itemize{
#'    \item \emph{Model} \code{sda} object containing the trained model
#'    \item \emph{FeatureList} \code{data.frame} description of 
